...
#         bnb_price = "${:,.0f}".format( price_data['binancecoin']['usd'], grouping=True )
...
#         bnb_liq_dlr_value = "${:,.0f}".format( bnb_liq_value, grouping=True )
#         o1t_liq_value = float(liq_tokens['O1T']) * float(price_data['only-1-token']['usd'])
#         o1t_liq_dlr_value = "${:,.0f}".format( o1t_liq_value, grouping=True )
#         liq_total = "${:,.0f}".format( float(bnb_liq_value) + float(o1t_liq_value), grouping=True )
...
#         bnb_o1t_dlr_value = "${:,.0f}".format( bnb_o1t_value, grouping=True ).split('$')[1]
